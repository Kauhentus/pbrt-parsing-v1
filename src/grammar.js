...
var grammar = {
    ...
    {"name": "pbrt_program", "symbols": ["pbrt_program$ebnf$1"], "postprocess": 
        (...args) => {
    ...
    {"name": "attributes", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws), "string", (lexer.has("ws") ? {type: "ws"} : ws), {"literal":"["}, "ws", "attributes$ebnf$1", {"literal":"]"}, "ws", "o_nl"], "postprocess": 
        (...args) => {
            return {
                'type': 'attribute',
                'name': args[0][0 + 1],
    ...
    {"name": "attributes", "symbols": [(lexer.has("ws") ? {type: "ws"} : ws), "string", (lexer.has("ws") ? {type: "ws"} : ws), "attributes$subexpression$1", "ws", "o_nl"], "postprocess": 
        (...args) => {
            return {
                'type': 'attribute',
                'name': args[0][0 + 1],
    ...
    {"name": "film_statement", "symbols": [{"literal":"Film"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Film',
    ...
    {"name": "lookat_statement", "symbols": [{"literal":"LookAt"}, "lookat_statement$ebnf$1", "ws", "o_nl"], "postprocess":  
        (...args) => {
    ...
    {"name": "camera_statement", "symbols": [{"literal":"Camera"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Camera',
    ...
    {"name": "sampler_statement", "symbols": [{"literal":"Sampler"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Sampler',
    ...
    {"name": "integrator_statement", "symbols": [{"literal":"Integrator"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Integrator',
    ...
    {"name": "worldbegin_statement", "symbols": [{"literal":"WorldBegin"}, "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'WorldBegin',
    ...
    {"name": "attributebegin_statement", "symbols": [{"literal":"AttributeBegin"}, "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'AttributeBegin',
    ...
    {"name": "attributeend_statement", "symbols": [{"literal":"AttributeEnd"}, "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'AttributeEnd',
    ...
    {"name": "objectbegin_statement", "symbols": [{"literal":"ObjectBegin"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'ObjectBegin',
    ...
    {"name": "objectend_statement", "symbols": [{"literal":"ObjectEnd"}, "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'ObjectEnd',
    ...
    {"name": "objectinstance_statment", "symbols": [{"literal":"ObjectInstance"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'ObjectInstance',
    ...
    {"name": "include_statement", "symbols": [{"literal":"Include"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Include',
    ...
    {"name": "rotate_statement", "symbols": [{"literal":"Rotate"}, "rotate_statement$ebnf$1", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Rotate',
    ...
    {"name": "translate_statement", "symbols": [{"literal":"Translate"}, "translate_statement$ebnf$1", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Translate',
    ...
    {"name": "identity_statement", "symbols": [{"literal":"Identity"}, "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Identity',
    ...
    {"name": "scale_statement", "symbols": [{"literal":"Scale"}, "scale_statement$ebnf$1", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Scale',
    ...
    {"name": "transform_statement", "symbols": [{"literal":"Transform"}, (lexer.has("ws") ? {type: "ws"} : ws), {"literal":"["}, (lexer.has("ws") ? {type: "ws"} : ws), "transform_statement$ebnf$1", {"literal":"]"}, "ws", "o_nl"], "postprocess":  
        (...args) => {
    ...
    {"name": "concattransform_statement", "symbols": [{"literal":"ConcatTransform"}, (lexer.has("ws") ? {type: "ws"} : ws), {"literal":"["}, (lexer.has("ws") ? {type: "ws"} : ws), "concattransform_statement$ebnf$1", {"literal":"]"}, "ws", "o_nl"], "postprocess":  
        (...args) => {
            // console.log(args[0][4]);
            return {
                'type': 'statement',
    ...
    {"name": "namedmaterial_statement", "symbols": [{"literal":"NamedMaterial"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'NamedMaterial',
    ...
    {"name": "shape_statement", "symbols": [{"literal":"Shape"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Shape',
    ...
    {"name": "arealightsource_statement", "symbols": [{"literal":"AreaLightSource"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
    ...
    {"name": "lightsource_statement", "symbols": [{"literal":"LightSource"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'LightSource',
    ...
    {"name": "texture_statement", "symbols": [{"literal":"Texture"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Texture',
    ...
    {"name": "makenamedmaterial_statement", "symbols": [{"literal":"MakeNamedMaterial"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
    ...
    {"name": "material_statement", "symbols": [{"literal":"Material"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
                'kind': 'Material',
    ...
    {"name": "mediuminterface_statement", "symbols": [{"literal":"MediumInterface"}, "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
    ...
    {"name": "makenamedmedium_statement", "symbols": [{"literal":"MakeNamedMedium"}, (lexer.has("ws") ? {type: "ws"} : ws), "string", "ws", "o_nl"], "postprocess":  
        (...args) => {
            return {
                'type': 'statement',
